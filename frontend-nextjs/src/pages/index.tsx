  ...
  return (
    <>
      <section className="relative min-h-[760px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_bottom,oklch(0.145_0.012_235/0.30),var(--background)_92%)]" />
        <div className="relative z-10 mx-auto flex min-h-[680px] max-w-7xl flex-col justify-center px-5 pb-16 pt-24 md:px-6 md:pt-28">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <div className="mb-6 inline-flex items-center gap-2 rounded-lg border border-white/12 bg-black/24 px-3 py-2 text-xs text-white/75 backdrop-blur">
              <span className="h-1.5 w-1.5 rounded-full bg-[var(--accent)]" />
              Cloud file storage
            </div>

            <h1 className="max-w-4xl text-5xl font-bold leading-[1.02] tracking-normal text-white md:text-7xl">
              CloudVault
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link href="/login">
                <Button size="lg" variant="outline" className="bg-black/25">
                  Đăng nhập
                </Button>
              </Link>
            </div>
            ...
            <div className="mt-7 flex flex-wrap gap-x-5 gap-y-2">
              {perks.map((perk) => (
                <span key={perk} className="flex items-center gap-1.5 text-sm text-white/72">
          ...
          <motion.div
            ...
            className="mt-12 grid max-w-2xl grid-cols-3 overflow-hidden rounded-lg border border-white/12 bg-black/28 backdrop-blur"
          >
            {[
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {services.map((service, index) => (
            <motion.div
              ...
              className="surface group rounded-lg p-5 transition hover:-translate-y-1 hover:border-[var(--primary)]/45"
            >
              <div
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-20 md:px-6">
        <div className="surface flex flex-col gap-6 rounded-lg p-6 md:flex-row md:items-center md:justify-between md:p-8">
          <div>
