...
export default function AnimatedShaderBackground() {
  ...
  useEffect(() => {
    ...
    // Cap at 1× on all devices — the shader is artistically low-res anyway
        ...
        void main() {
          ...
          for (float i = 0.0; i < 35.0; i++) {
            ...
            vec4 auroraColors = vec4(
              0.05 + 0.22 * sin(i * 0.2 + iTime * 0.4),
              0.32 + 0.45 * cos(i * 0.3 + iTime * 0.5),
              0.55 + 0.30 * sin(i * 0.4 + iTime * 0.3),
              1.0
            );
          ...
          gl_FragColor = vec4((o * 1.45).rgb, 1.0);
        }
      `,
    });
    ...
    // Pause rendering when the element is not visible in the viewport
    let visible = true;
    ...
    const animate = () => {
      ...
      if (!visible) return; // skip GPU work when off-screen
